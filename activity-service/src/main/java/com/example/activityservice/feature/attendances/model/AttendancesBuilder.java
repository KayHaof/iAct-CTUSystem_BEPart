...
public class AttendancesBuilder {
    ...
    public AttendancesBuilder schedule(com.example.activityservice.feature.activitySchedule.model.ActivitySchedule s) { instance.setSchedule(s); return this; }
    ...
    public AttendancesBuilder status(Integer status) { instance.setStatus(status); return this; }
