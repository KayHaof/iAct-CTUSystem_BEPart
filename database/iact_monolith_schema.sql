...
CREATE TABLE `activities` (
  ...
  `is_faculty` tinyint(1) DEFAULT '0' COMMENT '0: Cp trng, 1: Cp khoa',
  ...
  KEY `fk_activity_creator` (`created_by`),
  KEY `FKhpeyvld2vg3222acs7dhpd8c` (`handled_by`),
...
CREATE TABLE `activity_schedules` (
  ...
  `title` varchar(255) DEFAULT NULL COMMENT 'Tn bui (VD: Bui 1: Khai mc)',
  `start_time` datetime NOT NULL COMMENT 'Gi bt u bui',
  `end_time` datetime NOT NULL COMMENT 'Gi kt thc bui',
  `location` varchar(255) DEFAULT NULL COMMENT 'a im ca bui ny (nu khc a im chung)',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_activity_schedule_activity` (`activity_id`),
  CONSTRAINT `fk_activity_schedule_activity` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE
...
CREATE TABLE `award_criteria` (
  ...
  `min_point_required` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `complaints` (
  ...
  `status` int DEFAULT NULL,
  `detail_response` varchar(255) DEFAULT NULL,
  `resolved_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_complaint_student` (`student_id`),
  KEY `fk_complaint_activity` (`activity_id`),
  KEY `fk_complaint_semester` (`semester_id`),
...
CREATE TABLE `department_profiles` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `fk_dept_department` (`department_id`),
  CONSTRAINT `fk_dept_department` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  ...
  KEY `fk_notification_activity` (`activity_id`),
...
CREATE TABLE `organizers` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `fk_organizer_department` (`department_id`),
  KEY `fk_organizer_representative` (`representative_user`),
...
CREATE TABLE `proofs` (
  ...
  `verified_user` bigint DEFAULT NULL,
  `verified_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_proof_student` (`student_id`),
  KEY `fk_proof_activity` (`activity_id`),
  KEY `fk_proof_verified_user` (`verified_user`),
...
CREATE TABLE `registration_schedules` (
  ...
  KEY `FKgj750kcqxgr4wpl9kdmxs4e31` (`schedule_id`),
  KEY `FKsaoilc06l91wqn3yh59nu5csb` (`registration_id`),
  CONSTRAINT `FKgj750kcqxgr4wpl9kdmxs4e31` FOREIGN KEY (`schedule_id`) REFERENCES `activity_schedules` (`id`),
  CONSTRAINT `FKsaoilc06l91wqn3yh59nu5csb` FOREIGN KEY (`registration_id`) REFERENCES `registrations` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_awards` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_student_award_student` (`student_id`),
...
-- Dump completed on 2026-04-07  8:27:10
