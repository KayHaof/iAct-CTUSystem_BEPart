...
CREATE TABLE `activities` (
  ...
  `requires_admin_approval` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `activity_schedules` (
  ...
  `qr_code_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKg1sbml7hhxveji6dxjm0ajeww` (`qr_code_token`),
...
CREATE TABLE `attendances` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_attendance_registration_schedule` (`registration_id`,`schedule_id`),
...
--
-- Table structure for table `certificate_submission_complaints`
--

DROP TABLE IF EXISTS `certificate_submission_complaints`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `certificate_submission_complaints` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `complaint_reason` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(6) DEFAULT NULL,
  ...
  `status` int NOT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `certificate_submission_id` bigint NOT NULL,
  `reviewer_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK4ockh28hne1qfifbi0chfcijh` (`certificate_submission_id`),
  KEY `FKcos683pl2a5cu4ojk4rko2ac5` (`reviewer_id`),
  CONSTRAINT `FKcos683pl2a5cu4ojk4rko2ac5` FOREIGN KEY (`reviewer_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKs7akcqpqcv9nxibkyjwluwhlv` FOREIGN KEY (`certificate_submission_id`) REFERENCES `certificate_submissions` (`id`)
...
CREATE TABLE `face_checkin_attempts` (
  ...
  KEY `FK5lyc3ehgx9t9dagg6km3gcjw8` (`schedule_id`),
  CONSTRAINT `FK5lyc3ehgx9t9dagg6km3gcjw8` FOREIGN KEY (`schedule_id`) REFERENCES `activity_schedules` (`id`),
...
CREATE TABLE `registrations` (
  ...
  `absence_review_note` text COLLATE utf8mb4_unicode_ci,
  `absence_reviewed` bit(1) NOT NULL,
  `absence_reviewed_at` datetime(6) DEFAULT NULL,
  `absence_reviewed_by` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_activity_users_academic_year` (`academic_year`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'activity_db'
--
...
-- Dump completed on 2026-08-10 10:08:19
